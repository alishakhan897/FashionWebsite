...
class LoginPage extends Component {
    ...
    LoginSubmit = async (event) => {
        ...
        const url = "https://deployment-1-8stt.onrender.com/login";
        const options = {
            method: 'POST',
                    ...
                    <FormContainer>
                        ...
                        <FormSmallcontainer2>
                            <Form onSubmit={this.LoginSubmit}>
                                <InputContainer>
                                    <Lable>EMAIL</Lable>
                                    <Input2 type="text" placeholder="Enter your email" as={Placeholder} onChange={this.inputField} value={username} />
                                </InputContainer>
